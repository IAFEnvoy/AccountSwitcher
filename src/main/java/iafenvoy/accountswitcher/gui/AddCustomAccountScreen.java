...
public class AddCustomAccountScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawText(this.textRenderer, Text.translatable("as.gui.custom.label1"), this.width / 2 - 175, this.height / 2 - 45, 16777215, true);
        context.drawText(this.textRenderer, Text.translatable("as.gui.custom.label2"), this.width / 2 - 175, this.height / 2 - 20, 16777215, true);
        context.drawText(this.textRenderer, Text.translatable("as.gui.custom.label3"), this.width / 2 - 175, this.height / 2 + 5, 16777215, true);
