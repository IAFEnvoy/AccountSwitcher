...
public class AddCustomAccountScreen extends Screen {
    ...
    protected void init() {
        super.init();
        this.username = this.addButton(new TextFieldWidget(client.textRenderer, this.width / 2 - 100, this.height / 2 - 50, 200, 20, new LiteralText("")));
        this.uuid = this.addButton(new TextFieldWidget(client.textRenderer, this.width / 2 - 100, this.height / 2 - 25, 200, 20, new LiteralText("")));
        this.token = this.addButton(new TextFieldWidget(client.textRenderer, this.width / 2 - 100, this.height / 2, 200, 20, new LiteralText("")));
